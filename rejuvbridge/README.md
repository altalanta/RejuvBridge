...
> ⚠️ **Capabilities**: deterministic data generation, ResNet18 + MLP encoders, CLIP InfoNCE training, retrieval@K with bootstrap CIs, UMAP and Grad-CAM visual diagnostics.
>
